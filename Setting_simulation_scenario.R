...
stoch_scenarios <- expand.grid(list(seed = 1:seeds,
                                    ...
                                    snails = c("Mild"),
                                    zeta = rlnorm(10, -2.3, 0.5), # runif(20, 0.01, 0.5),
                                    #worms_aggr = c(0.05, seq(0.1, 0.5, 0.1)),
                                    #zeta = seq(10^(-5), 0.5, 5*10^(-3)),
                                    worms_aggr = c(0.15, 0.2, 0.25),
                                    #tr_snails = c(10^(-10), 2*10^(-10), 5*10^(-10), 10^(-9), 5*10^(-9)))) #or runif(20, -25, -20)
                                    tr_snails = rlnorm(10, -23.7, 0.8)))
...
################
setting <- "Grid_search_Panel4_retuning"
