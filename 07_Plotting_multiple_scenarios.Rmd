...
age_out$time <- factor(as.factor(age_out$time), 
                       levels = c("141", "161"), labels = c("Pre",  "Post"))
...
rate <- ggplot(data_toplot, aes(x=age_group, y=rate_mean+0.5, group = interaction(DDF, time)))+
...
#Worms
worms <- ggplot(data_toplot, aes(x=age_group, y=wp_mean+0.5, group = interaction(DDF, time)))+
...
#Dead worm pairs
dead_worms <- ggplot(data_toplot, aes(x=age_group, y=dwp_mean+0.5, group = interaction(DDF, time)))+
